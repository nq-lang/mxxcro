...
def inject_css() -> None:
    ...
    /* ── Column proportionality — stretch columns to fill available height ── */
    ...
    /* Radio button row for price range tabs */
...
def render_conflict_globe() -> None:
    ...
    fig.update_geos(
        ...
        lataxis=dict(showgrid=True, gridcolor="rgba(26,29,36,0.4)"),
        lonaxis=dict(showgrid=True, gridcolor="rgba(26,29,36,0.4)"),
    )
...
_UNDERVALUED_CANDIDATES: List[Dict] = [
    # ── $80–$150 range ──────────────────────────────────────────────────────
    {
        "ticker": "GOOG",  "name": "Alphabet Inc.",     "sector": "Communication", "market": "US",
        "price": 157.20,   "status": "UNDERVALUED",     "roi_pct": 38,
        "pullback_lo": 142.00, "pullback_hi": 152.00,
        ...
        "fundamentals": "PEG 0.82 · ROE 27.3% · FCF MoS +38% · Altman Z 4.2 · Net cash position",
    },
    {
        "ticker": "META",  "name": "Meta Platforms",    "sector": "Communication", "market": "US",
        "price": 501.30,   "status": "UNDERVALUED",     "roi_pct": 32,
        "pullback_lo": 455.00, "pullback_hi": 478.00,
        ...
        "fundamentals": "PEG 0.91 · ROE 35.2% · ROIC 29.4% · Gross Margin 81% · FCF MoS +32%",
    },
    {
        "ticker": "AVGO",  "name": "Broadcom Inc.",     "sector": "Technology",    "market": "US",
        "price": 198.40,   "status": "UNDERVALUED",     "roi_pct": 28,
        "pullback_lo": 178.00, "pullback_hi": 192.00,
        ...
        "fundamentals": "FWD P/E 25x · ROE 32.5% · EV/EBITDA 18.3x · AI revenue accelerating 60% YoY",
    },
    {
        "ticker": "HSBA",  "name": "HSBC Holdings",     "sector": "Financial",     "market": "UK",
        "price": 112.60,   "status": "UNDERVALUED",     "roi_pct": 31,
        "pullback_lo": 102.00, "pullback_hi": 108.00,
        "val_score": 25, "qual_score": 20, "macro_score": 16, "catalyst_score": 11, "dcf_mos": 8,
        "total": 80,
        "pe": 9.8,  "fwd_pe": 8.9,  "ev_ebitda": 6.1,  "pb": 1.0, "pfcf": 8.4,  "peg": 0.68,
        "de": 2.10, "altman": 2.9, "roe": 14.2, "roic": 11.8, "gross_margin": 55.0,
        "fcf_mos": 29, "signal": "Buy",
        "thesis": "Dividend yield 6.8%. Asia pivot driving NII growth. P/B 1.0x vs sector avg 1.4x.",
        "fundamentals": "P/E 9.8x · Div Yield 6.8% · P/B 1.0x · NII growth Asia +18% YoY",
    },
    # ── $50–$80 range ──────────────────────────────────────────────────────
    {
        "ticker": "JPM",   "name": "JPMorgan Chase",    "sector": "Financial",     "market": "US",
        "price": 238.50,   "status": "FAIRLY VALUED",   "roi_pct": 22,
        "pullback_lo": 218.00, "pullback_hi": 228.00,
        ...
        "fundamentals": "PEG 0.74 · ROE 17.4% · FCF MoS +44% · P/B 1.8x · NII expansion tailwind",
    },
    {
        "ticker": "V",     "name": "Visa Inc.",          "sector": "Financial",     "market": "US",
        "price": 298.10,   "status": "FAIRLY VALUED",   "roi_pct": 18,
        "pullback_lo": 268.00, "pullback_hi": 282.00,
        ...
        "fundamentals": "ROE 44.8% · ROIC 38.2% · Gross Margin 80.5% · Altman Z 5.1 · Net margin 51%",
    },
    {
        "ticker": "LLOY",  "name": "Lloyds Banking",    "sector": "Financial",     "market": "UK",
        "price": 68.40,    "status": "EXTREMELY UNDERVALUED", "roi_pct": 58,
        "pullback_lo": 60.00, "pullback_hi": 65.00,
        "val_score": 26, "qual_score": 18, "macro_score": 17, "catalyst_score": 10, "dcf_mos": 7,
        "total": 78,
        "pe": 7.2,  "fwd_pe": 6.5,  "ev_ebitda": 5.2,  "pb": 0.72, "pfcf": 6.8, "peg": 0.51,
        "de": 2.40, "altman": 2.2, "roe": 12.4, "roic": 9.8, "gross_margin": 48.0,
        "fcf_mos": 41, "signal": "Strong Buy",
        "thesis": "P/B 0.72x — trading below book value. Motor Finance provision overhang cleared. Div yield 5.2%.",
        "fundamentals": "P/B 0.72x · P/E 7.2x · Div Yield 5.2% · FCA provision cleared · NIM expanding",
    },
    {
        "ticker": "XOM",   "name": "ExxonMobil",        "sector": "Energy",        "market": "US",
        "price": 112.80,   "status": "UNDERVALUED",     "roi_pct": 35,
        "pullback_lo": 100.00, "pullback_hi": 108.00,
        ...
        "fundamentals": "PEG 0.62 · FCF MoS +35% · $35B buyback · Div Yield 3.4% · Debt/Equity 0.20",
    },
    # ── $40–$50 range ──────────────────────────────────────────────────────
    {
        "ticker": "BAC",   "name": "Bank of America",   "sector": "Financial",     "market": "US",
        "price": 43.80,    "status": "UNDERVALUED",     "roi_pct": 42,
        "pullback_lo": 38.50, "pullback_hi": 41.50,
        "val_score": 25, "qual_score": 19, "macro_score": 17, "catalyst_score": 10, "dcf_mos": 7,
        "total": 78,
        "pe": 13.2, "fwd_pe": 11.6, "ev_ebitda": 7.8, "pb": 1.2, "pfcf": 9.4, "peg": 0.71,
        "de": 1.04, "altman": 2.8, "roe": 11.2, "roic": 9.6, "gross_margin": 52.0,
        "fcf_mos": 36, "signal": "Buy",
        "thesis": "Rate sensitivity play. NII set to expand 15%+ as fixed-rate book reprices through 2026.",
        "fundamentals": "P/E 13.2x · P/B 1.2x · NII repricing tailwind · ROE 11.2% · Div Yield 2.6%",
    },
    {
        "ticker": "BCSF",  "name": "Barclays (ADR)",    "sector": "Financial",     "market": "UK",
        "price": 14.20,    "status": "EXTREMELY UNDERVALUED", "roi_pct": 62,
        "pullback_lo": 12.00, "pullback_hi": 13.40,
        "val_score": 24, "qual_score": 17, "macro_score": 16, "catalyst_score": 9,  "dcf_mos": 7,
        "total": 73,
        "pe": 6.8,  "fwd_pe": 6.1,  "ev_ebitda": 4.8,  "pb": 0.65, "pfcf": 5.9, "peg": 0.48,
        "de": 2.80, "altman": 2.0, "roe": 10.8, "roic": 8.4, "gross_margin": 44.0,
        "fcf_mos": 44, "signal": "Strong Buy",
        "thesis": "P/B 0.65x. IB revenue recovery. UK retail NIM at decade highs. £10B buyback programme underway.",
        "fundamentals": "P/B 0.65x · P/E 6.8x · CET1 13.8% · IB recovery · £10B buyback active",
    },
    {
        "ticker": "WBD",   "name": "Warner Bros. Discovery", "sector": "Media",   "market": "US",
        "price": 12.40,    "status": "EXTREMELY UNDERVALUED", "roi_pct": 78,
        "pullback_lo": 10.50, "pullback_hi": 11.80,
        "val_score": 22, "qual_score": 15, "macro_score": 14, "catalyst_score": 12, "dcf_mos": 6,
        "total": 69,
        "pe": 18.4, "fwd_pe": 9.8,  "ev_ebitda": 6.4,  "pb": 0.88, "pfcf": 7.2, "peg": 0.55,
        "de": 2.10, "altman": 1.9, "roe": 5.2,  "roic": 4.8, "gross_margin": 42.0,
        "fcf_mos": 52, "signal": "Speculative Buy",
        "thesis": "Debt paydown on track. Direct-to-consumer profitability inflection in 2025. Max streaming beats.",
        "fundamentals": "EV/EBITDA 6.4x · FCF MoS +52% · DTC inflection · Debt paydown $2B/yr · P/B 0.88x",
    },
    # ── $20–$35 range ──────────────────────────────────────────────────────
    {
        "ticker": "VZ",    "name": "Verizon Comms.",    "sector": "Telecom",       "market": "US",
        "price": 31.20,    "status": "UNDERVALUED",     "roi_pct": 34,
        "pullback_lo": 27.50, "pullback_hi": 29.80,
        "val_score": 23, "qual_score": 17, "macro_score": 15, "catalyst_score": 9,  "dcf_mos": 8,
        "total": 72,
        "pe": 15.8, "fwd_pe": 9.2,  "ev_ebitda": 7.1,  "pb": 1.6, "pfcf": 8.8, "peg": 0.58,
        "de": 1.80, "altman": 2.4, "roe": 21.4, "roic": 8.2, "gross_margin": 58.4,
        "fcf_mos": 31, "signal": "Buy",
        "thesis": "Dividend yield 6.4% with payout coverage 2.2x FCF. 5G fixed wireless access accelerating.",
        "fundamentals": "Div Yield 6.4% · FCF coverage 2.2x · FWD P/E 9.2x · 5G FWA adds +400K/qtr",
    },
    {
        "ticker": "ADBE",  "name": "Adobe Inc.",        "sector": "Technology",    "market": "US",
        "price": 389.50,   "status": "FAIRLY VALUED",   "roi_pct": 21,
        "pullback_lo": 340.00, "pullback_hi": 362.00,
        ...
        "fundamentals": "Gross Margin 88.2% · ROIC 29.8% · NRR >120% · Firefly AI monetisation layer new",
    },
    {
        "ticker": "TSCO",  "name": "Tesco PLC",         "sector": "Consumer",      "market": "UK",
        "price": 28.60,    "status": "UNDERVALUED",     "roi_pct": 29,
        "pullback_lo": 25.00, "pullback_hi": 27.20,
        "val_score": 22, "qual_score": 17, "macro_score": 15, "catalyst_score": 9,  "dcf_mos": 6,
        "total": 69,
        "pe": 15.2, "fwd_pe": 13.8, "ev_ebitda": 8.4,  "pb": 2.8, "pfcf": 11.2, "peg": 0.92,
        "de": 0.72, "altman": 2.6, "roe": 18.4, "roic": 11.2, "gross_margin": 6.4,
        "fcf_mos": 24, "signal": "Buy",
        "thesis": "Market share gains vs discounters. Clubcard data monetisation through dunnhumby. Div 4.1%.",
        "fundamentals": "FWD P/E 13.8x · Div Yield 4.1% · Market share +0.6pp YoY · Clubcard 22M users",
    },
    {
        "ticker": "MSFT",  "name": "Microsoft Corp.",   "sector": "Technology",    "market": "US",
        "price": 415.20,   "status": "FAIRLY VALUED",   "roi_pct": 19,
        "pullback_lo": 372.00, "pullback_hi": 395.00,
        ...
        "fundamentals": "ROIC 34.2% · Azure +30% growth · Copilot ARR $4B+ · Altman Z 4.8 · $80B FCF",
    },
    # ── $10–$20 range ──────────────────────────────────────────────────────
    {
        "ticker": "PFE",   "name": "Pfizer Inc.",        "sector": "Healthcare",   "market": "US",
        "price": 13.80,    "status": "EXTREMELY UNDERVALUED", "roi_pct": 68,
        "pullback_lo": 11.80, "pullback_hi": 13.00,
        "val_score": 24, "qual_score": 16, "macro_score": 14, "catalyst_score": 11, "dcf_mos": 8,
        "total": 73,
        "pe": 11.2, "fwd_pe": 9.8,  "ev_ebitda": 7.2,  "pb": 1.4, "pfcf": 8.8, "peg": 0.58,
        "de": 0.61, "altman": 3.2, "roe": 9.4,  "roic": 8.1, "gross_margin": 53.8,
        "fcf_mos": 48, "signal": "Strong Buy",
        "thesis": "Pipeline optionality underpriced — 20+ Phase 3 trials. Dividend yield 6.8%. Post-COVID reset complete.",
        "fundamentals": "Div Yield 6.8% · Pipeline 20+ Ph3 · FCF MoS +48% · P/E 11.2x · ROE recovering",
    },
    {
        "ticker": "INTC",  "name": "Intel Corp.",        "sector": "Technology",   "market": "US",
        "price": 18.40,    "status": "EXTREMELY UNDERVALUED", "roi_pct": 72,
        "pullback_lo": 15.50, "pullback_hi": 17.20,
        "val_score": 20, "qual_score": 14, "macro_score": 16, "catalyst_score": 13, "dcf_mos": 6,
        "total": 69,
        "pe": 22.8, "fwd_pe": 14.2, "ev_ebitda": 9.4,  "pb": 1.0, "pfcf": 11.8, "peg": 0.62,
        "de": 0.52, "altman": 2.4, "roe": 2.8,  "roic": 3.2, "gross_margin": 38.8,
        "fcf_mos": 55, "signal": "Speculative Buy",
        "thesis": "18A process node competitive inflection. Foundry TAM $100B+. Intel Foundry Services ramp 2025.",
        "fundamentals": "P/B 1.0x · FCF MoS +55% · 18A node vs TSMC · US CHIPS Act $8.5B · Foundry optionality",
    },
    {
        "ticker": "AAL",   "name": "American Airlines",  "sector": "Transport",    "market": "US",
        "price": 11.80,    "status": "EXTREMELY UNDERVALUED", "roi_pct": 85,
        "pullback_lo": 9.80, "pullback_hi": 11.00,
        "val_score": 18, "qual_score": 13, "macro_score": 14, "catalyst_score": 12, "dcf_mos": 5,
        "total": 62,
        "pe": 6.4,  "fwd_pe": 5.8,  "ev_ebitda": 5.1,  "pb": 0.0, "pfcf": 4.8, "peg": 0.38,
        "de": 9.80, "altman": 1.4, "roe": 48.2, "roic": 6.4, "gross_margin": 22.4,
        "fcf_mos": 62, "signal": "Speculative Buy",
        "thesis": "Travel demand structurally elevated. Debt paydown $15B by 2026. FCF yield 12%+ if load holds.",
        "fundamentals": "FCF yield 12% · EV/EBITDA 5.1x · Load factor 87% · Debt paydown $15B plan · High risk",
    },
    {
        "ticker": "BATS",  "name": "BAT PLC (ADR)",     "sector": "Consumer",      "market": "UK",
        "price": 16.20,    "status": "EXTREMELY UNDERVALUED", "roi_pct": 55,
        "pullback_lo": 14.00, "pullback_hi": 15.50,
        "val_score": 22, "qual_score": 16, "macro_score": 13, "catalyst_score": 10, "dcf_mos": 8,
        "total": 69,
        "pe": 7.8,  "fwd_pe": 7.1,  "ev_ebitda": 8.4,  "pb": 1.2, "pfcf": 6.8, "peg": 0.44,
        "de": 1.62, "altman": 2.1, "roe": 16.2, "roic": 10.8, "gross_margin": 72.4,
        "fcf_mos": 42, "signal": "Buy",
        "thesis": "Dividend yield 9.2%. NGP transition (Vuse, Velo) growing 28% YoY. Combustibles still FCF engine.",
        "fundamentals": "Div Yield 9.2% · NGP growth 28% · FCF MoS +42% · P/E 7.8x · Gross Margin 72%",
    },
    # ── $5–$10 range ──────────────────────────────────────────────────────
    {
        "ticker": "SNAP",  "name": "Snap Inc.",          "sector": "Technology",   "market": "US",
        "price": 9.20,     "status": "EXTREMELY UNDERVALUED", "roi_pct": 92,
        "pullback_lo": 7.50, "pullback_hi": 8.60,
        "val_score": 17, "qual_score": 13, "macro_score": 13, "catalyst_score": 11, "dcf_mos": 4,
        "total": 58,
        "pe": 0.0,  "fwd_pe": 28.4, "ev_ebitda": 14.8, "pb": 6.2, "pfcf": 0.0, "peg": 0.0,
        "de": 0.88, "altman": 1.8, "roe": -18.4, "roic": -8.2, "gross_margin": 52.4,
        "fcf_mos": 0, "signal": "Speculative Buy",
        "thesis": "DAU growth reaccelerating +9% YoY. AR glasses + Spotlight monetisation pre-revenue. $2.2B cash.",
        "fundamentals": "DAU +9% YoY · AR monetisation option · Gross Margin 52% · $2.2B cash · EV/Rev 2.1x",
    },
    {
        "ticker": "CLF",   "name": "Cleveland-Cliffs",   "sector": "Materials",    "market": "US",
        "price": 8.10,     "status": "EXTREMELY UNDERVALUED", "roi_pct": 88,
        "pullback_lo": 6.50, "pullback_hi": 7.60,
        "val_score": 20, "qual_score": 12, "macro_score": 15, "catalyst_score": 10, "dcf_mos": 5,
        "total": 62,
        "pe": 0.0,  "fwd_pe": 7.2,  "ev_ebitda": 5.8,  "pb": 0.62, "pfcf": 5.4, "peg": 0.42,
        "de": 1.44, "altman": 1.6, "roe": -4.2, "roic": 2.8, "gross_margin": 12.4,
        "fcf_mos": 44, "signal": "Speculative Buy",
        "thesis": "US tariffs on steel imports structurally benefit domestic producer. Auto sector supply captive. P/B 0.62x.",
        "fundamentals": "P/B 0.62x · EV/EBITDA 5.8x · US tariff beneficiary · Auto captive supply · Steel cycle",
    },
    {
        "ticker": "SOFI",  "name": "SoFi Technologies",  "sector": "Financial",   "market": "US",
        "price": 9.40,     "status": "EXTREMELY UNDERVALUED", "roi_pct": 95,
        "pullback_lo": 7.80, "pullback_hi": 8.80,
        "val_score": 18, "qual_score": 14, "macro_score": 14, "catalyst_score": 12, "dcf_mos": 4,
        "total": 62,
        "pe": 0.0,  "fwd_pe": 22.8, "ev_ebitda": 18.4, "pb": 1.4, "pfcf": 0.0, "peg": 0.0,
        "de": 0.82, "altman": 2.2, "roe": 2.8,  "roic": 2.2, "gross_margin": 84.2,
        "fcf_mos": 0, "signal": "Speculative Buy",
        "thesis": "Bank charter unlocked lower cost of funds. Member growth +35% YoY. First profitable year 2024.",
        "fundamentals": "Bank charter secured · Members +35% YoY · Tech segment 80%+ margin · First GAAP profit 2024",
    },
    {
        "ticker": "VOD",   "name": "Vodafone Group",     "sector": "Telecom",      "market": "UK",
        "price": 6.80,     "status": "EXTREMELY UNDERVALUED", "roi_pct": 74,
        "pullback_lo": 5.80, "pullback_hi": 6.40,
        "val_score": 20, "qual_score": 14, "macro_score": 14, "catalyst_score": 9,  "dcf_mos": 6,
        "total": 63,
        "pe": 0.0,  "fwd_pe": 9.2,  "ev_ebitda": 5.4,  "pb": 0.52, "pfcf": 4.8, "peg": 0.40,
        "de": 1.88, "altman": 1.6, "roe": 1.4,  "roic": 2.4, "gross_margin": 28.4,
        "fcf_mos": 38, "signal": "Speculative Buy",
        "thesis": "Three UK merger approved — cost synergies £700M. Germany stabilising. P/B 0.52x historic low.",
        "fundamentals": "P/B 0.52x · EV/EBITDA 5.4x · Three UK merger £700M synergies · Div yield post-cut 4.8%",
    },
]
...
_STATUS_COLORS = {
    "EXTREMELY UNDERVALUED": "#ff5252",
    "UNDERVALUED":           "#4caf7d",
    "FAIRLY VALUED":         "#e0a050",
}


def render_undervalued_stocks_model() -> None:
    """Decrypt Undervalued Stocks — price-range table with ROI, buy zones & fundamentals."""
    phdr("Decrypt Undervalued Stocks", "MULTI-FACTOR SCORING MODEL · USA & UK EQUITIES", "green")

    # ── Price-range subtab selector ───────────────────────────────────────
    range_labels = [r[0] for r in _PRICE_RANGES]
    ...
    lo, hi = next((r[1], r[2]) for r in _PRICE_RANGES if r[0] == selected_tab)

    filtered = [s for s in _UNDERVALUED_CANDIDATES if lo <= s["price"] < hi]

    if not filtered:
        st.markdown(
            f'<div class="tp" style="padding:16px;text-align:center;color:{C["muted"]};">'
            f'No candidates in this price range currently.</div>',
            unsafe_allow_html=True,
        )
        return
    ...
    # ── Header row ────────────────────────────────────────────────────────
    st.markdown(
        f'<div style="display:grid;grid-template-columns:2fr 1.6fr 2.4fr;gap:6px;'
        f'padding:5px 10px;background:{C["panel_alt"]};border:1px solid {C["border"]};'
        f'border-radius:3px 3px 0 0;margin-top:6px;">'
        f'<div style="font-size:7.5px;letter-spacing:1.5px;color:{C["gold"]};font-weight:700;">STOCK · STATUS · ROI</div>'
        f'<div style="font-size:7.5px;letter-spacing:1.5px;color:{C["gold"]};font-weight:700;">IDEAL BUY ZONE</div>'
        f'<div style="font-size:7.5px;letter-spacing:1.5px;color:{C["gold"]};font-weight:700;">FUNDAMENTAL RATIONALE</div>'
        f'</div>',
        unsafe_allow_html=True,
    )

    # ── Rows ──────────────────────────────────────────────────────────────
    for i, s in enumerate(sorted(filtered, key=lambda x: -x["roi_pct"])):
        sc      = _STATUS_COLORS.get(s["status"], C["text_dim"])
        sig_col = (C["green_br"] if "Strong Buy" in s["signal"]
                   else C["gold"] if "Buy" in s["signal"]
                   else C["orange_br"] if "Hold" in s["signal"]
                   else C["text_dim"])
        mkt_col = C["blue_br"] if s["market"] == "US" else C["purple"]
        roi_bar = min(s["roi_pct"], 100)
        border_t = f'border-top:1px solid {C["border"]};' if i > 0 else ''

        st.markdown(
            f'<div style="display:grid;grid-template-columns:2fr 1.6fr 2.4fr;gap:6px;'
            f'padding:10px;background:{C["panel"]};{border_t}border-left:1px solid {C["border"]};'
            f'border-right:1px solid {C["border"]};">'

            # COL 1 — Stock / Status / ROI
            f'<div>'
            f'<div style="display:flex;align-items:center;gap:6px;margin-bottom:3px;">'
            f'<span style="font-family:Syne,sans-serif;font-size:13px;font-weight:800;color:{C["gold"]};">'
            f'{s["ticker"]}</span>'
            f'<span style="font-size:7px;padding:1px 5px;border-radius:2px;background:rgba(0,0,0,0.4);'
            f'border:1px solid {mkt_col}44;color:{mkt_col};font-weight:700;">{s["market"]}</span>'
            f'</div>'
            f'<div style="font-size:8px;color:{C["text_dim"]};margin-bottom:4px;">{s["name"]}</div>'
            f'<div style="font-size:11px;font-weight:700;color:#e8eaf0;margin-bottom:3px;">'
            f'${s["price"]:,.2f}</div>'
            f'<div style="font-size:7.5px;font-weight:700;color:{sc};letter-spacing:0.8px;margin-bottom:5px;">'
            f'{s["status"]}</div>'
            f'<div style="display:flex;justify-content:space-between;font-size:8px;'
            f'color:{C["muted"]};margin-bottom:2px;">'
            f'<span>EST. ROI</span>'
            f'<span style="color:{C["green_br"]};font-weight:700;">{s["roi_pct"]}%</span></div>'
            f'<div style="background:{C["border2"]};height:4px;border-radius:2px;">'
            f'<div style="width:{roi_bar}%;height:100%;border-radius:2px;'
            f'background:linear-gradient(90deg,{C["green"]},{C["green_br"]});"></div></div>'
            f'<div style="margin-top:4px;">'
            f'<span style="font-size:7px;padding:1px 6px;border-radius:2px;'
            f'background:rgba(0,0,0,0.3);border:1px solid {sig_col}44;color:{sig_col};'
            f'font-weight:700;">{s["signal"].upper()}</span>'
            f'</div></div>'

            # COL 2 — Buy Zone
            f'<div style="display:flex;flex-direction:column;justify-content:center;">'
            f'<div style="font-size:7.5px;letter-spacing:1px;color:{C["muted"]};margin-bottom:4px;">PULLBACK BUY RANGE</div>'
            f'<div style="background:{C["panel_alt"]};border:1px solid {C["border2"]};'
            f'border-radius:4px;padding:8px 10px;text-align:center;">'
            f'<div style="font-family:Syne,sans-serif;font-size:13px;font-weight:800;'
            f'color:{C["green_br"]};">${s["pullback_lo"]:,.2f}</div>'
            f'<div style="font-size:8px;color:{C["muted"]};margin:2px 0;">— to —</div>'
            f'<div style="font-family:Syne,sans-serif;font-size:13px;font-weight:800;'
            f'color:{C["green_br"]};">${s["pullback_hi"]:,.2f}</div>'
            f'</div>'
            f'<div style="font-size:7px;color:{C["text_dim"]};margin-top:5px;line-height:1.4;">'
            f'Based on DCF intrinsic value, support levels &amp; macro-adjusted margin of safety.</div>'
            f'</div>'

            # COL 3 — Fundamentals
            f'<div style="display:flex;flex-direction:column;justify-content:center;">'
            f'<div style="font-size:7.5px;letter-spacing:1px;color:{C["muted"]};margin-bottom:4px;">KEY FUNDAMENTALS</div>'
            f'<div style="font-size:8.5px;color:{C["text"]};line-height:1.6;margin-bottom:5px;">'
            f'{s["fundamentals"]}</div>'
            f'<div style="font-size:8px;color:{C["text_dim"]};line-height:1.45;'
            f'padding-top:5px;border-top:1px solid {C["border"]};font-style:italic;">'
            f'{s["thesis"]}</div>'
            f'</div>'
    ...
    # ── Footer ────────────────────────────────────────────────────────────
    st.markdown(
        f'<div style="padding:5px 10px;background:{C["panel_alt"]};'
        f'border:1px solid {C["border"]};border-top:none;border-radius:0 0 3px 3px;">'
        f'<span style="font-size:7px;color:{C["muted"]};">⚠ Model output for informational purposes only. '
        f'Not financial advice. Buy zones are DCF + technical support estimates. Verify with live data.</span>'
        f'</div>',
        unsafe_allow_html=True,
    )
...
def _render_tab_macro_v2_inner() -> None:
    ...
    with center_col:
        ...
        # Decrypt Undervalued Stocks — full-width table in center for best readability
